...
const CARD_TOGGLE_LABELS: Record<string, string> = {
  ...
  btnToggleOrthoCard: "toothInfo.orthodontics",
  btnToggleToothCard: "tooth.title",
...
const cardConfig = [
  { card: "#statusCard", btn: "#btnToggleStatusCard", labelKey: "status.title" },
  { card: "#toothCard", btn: "#btnToggleToothCard", labelKey: "tooth.title" },
  { card: "#orthoCard", btn: "#btnToggleOrthoCard", labelKey: "toothInfo.orthodontics" },
